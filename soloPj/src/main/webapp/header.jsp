...
<link href="<%=request.getContextPath()%>/css/base.css" rel="stylesheet">
 <header>
      ...
      <ul>
        ...
        <li><a href="<%=request.getContextPath()%>/all/all.jsp" class="nav-link px-2 link-dark">전체 글</a></li>
      ...
      <div class="headbtn">
        ...
        <button type="button"  class="btn btn-primary" onclick="location.href='login/login.jsp'">로그인</button>
        <button type="button" class="btn btn-primary" onclick="location.href='main.jsp'">홈</button>
      </div>
    </header>