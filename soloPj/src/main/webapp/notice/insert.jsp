			...
			<table border="1" class="table table-bordered">
				<thead>
					<tr>
						...
						<th class="tabth" ><input name="nwriter" value="<%=userName%>"></th>
				...
				<tbody>
					<tr>
						<th>제목</th>
						<td colspan="7"><input type="text" name="nsubject" class="tbin"></td>
					</tr>
					<tr class="textarea">
						<td colspan="8" rowspan="3" class="trtd">
							<textarea name="ncontent" rows="3"></textarea>
						</td>
					</tr>
				</tbody>
			</table>
			<input class="btn" type="submit" value="등록">
			<input class="btn" type="button" value="취소" onclick="location.href='notice.jsp'">
