...
<body>
	...
	<section>
		...
		<form action="insertOk.jsp" method="post" enctype="multipart/form-data">
			<table border="1" class="table table-bordered">
				<thead>
					<tr>
						...
						<th class="tabth" ><input name="twriter" value="<%=userName%>"></th>
				...
				<tbody>
					<tr>
						<th>제목</th>
						<td colspan="7"><input type="text" name="tsubject" class="tbin"></td>
					</tr>
					<tr class="textarea">
						<td colspan="8" rowspan="3" class="trtd">
							<textarea name="tcontent" rows="3"></textarea>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<input type="button" value="취소" onclick="location.href='teamboard.jsp'">
